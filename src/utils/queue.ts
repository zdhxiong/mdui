...
const container: PlainObject<Function[]> = {};

/**
 * 根据队列名，获取队列中所有函数
 * @param name 队列名
 */
function queue(name: string): Function[];
 ...
 * @param func 函数
 */
function queue(name: string, func: Function): void;

function queue(name: string, func?: Function): void | Function[] {
