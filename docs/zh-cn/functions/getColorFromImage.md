`getColorFromImage` 函数用于从一张给定的图片中提取出主色调。获取主色调后，可以再使用 [`setColorScheme`](/zh-cn/docs/2/functions/setColorScheme) 函数设置配色方案，以此实现[动态配色](/zh-cn/docs/2/styles/dynamic-color)功能。
