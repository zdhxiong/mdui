...
This function utilizes the [`ResizeObserver`](https://developer.mozilla.org/en-US/docs/Web/API/ResizeObserver) API and implements the singleton pattern for enhanced performance.
