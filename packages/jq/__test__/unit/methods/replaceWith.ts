...
<div class="container">
  ...
  it('.replaceWith(html)', function () {
    ...
    assert.sameOrderedMembers(toInnerTextArray($result), ['And']);
  ...
  it('.replaceWith(html)', function () {
    ...
    assert.sameOrderedMembers(toInnerTextArray($result), ['test', 'yyy']);
  ...
  it('.replaceWith(callback)', function () {
    ...
    const $children = $('.container').children();
    assert.sameOrderedMembers(toInnerTextArray($children), ['test', 'yyy']);
  });
